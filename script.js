document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
      ...
      const label = field.closest('.form-group, .field-wrapper, label')
        ? (field.closest('.form-group, .field-wrapper')
            ? (field.closest('.form-group, .field-wrapper').querySelector('label')
                ...
                : field.name || field.placeholder || 'This field')
            : field.name || field.placeholder || 'This field')
        : field.name || field.placeholder || 'This field';
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (field.matches('input, textarea, select') && !field.matches('[type="submit"], [type="button"], [type="hidden"]')) {
        validateField(field);
      }
    }, true);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Stella Fitness משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '31efb6f1-defd-4fa5-b7c1-5bea2a19ec64',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '31efb6f1-defd-4fa5-b7c1-5bea2a19ec64';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '31efb6f1-defd-4fa5-b7c1-5bea2a19ec64';
